...
return [
    ...
    "servProd" => "Servicios y productos",
    "infoUs" => "Somos NRP-tech una compañía informática que se dedica a vender productos y ofrecer servicios desde 2023",
    "infoServProd" => "Aquí encontrarás todos los productos informáticos desde componentes de pc, móviles, drivers junto a diversos servicios informáticos que engloben las reparaciones o montajes.",
    "promise" => "Nosotros nos comprometemos a dar lo mejor de nosotros para poder satisfacer las necesidades de nuestros clientes de la mejor manera posible.",
    ...
    "langEn" => "Inglés",
    "langEsp" => "Español",
    "emptyCart" => "El carrito está vacio",
