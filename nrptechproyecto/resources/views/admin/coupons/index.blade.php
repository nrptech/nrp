                        ...
                        <tr id="view{{ $coupon->id }}" class="view">
                            ...
                            <tr hidden id="edit{{ $coupon->id }}" class="edit">
                                ...
                                <form method="POST" action="{{ route('coupons.update', $coupon->id) }}">
                                    ...
                                    <td><input type="text" name="name" value="{{ $coupon->name }}" class="form-control"></td>
                                    <td><input type="datetime-local" name="expiration" value="{{ $coupon->expiration }}" class="form-control"></td>
                                    <td><input type="number" name="quantity" value="{{ $coupon->quantity }}" class="form-control"></td>
                                    <td><input type="number" name="discount" value="{{ $coupon->discount }}" class="form-control"></td>
